  ...
  <div class="row mx-auto text-center">
    @foreach($vehicleTypes as $v)
      <div class="col-md-3 mb-4">
        <div class="vehicle-card" data-id="{{ $v->vehicle_Type_ID }}" style="width: 20rem;border-radius:10px;height:300px;background-color:white" data-id="{{ $v->id }}">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="myModalLabel" style="color: orange"><i class="fas fa-exclamation-circle"></i> Attention</h5>
