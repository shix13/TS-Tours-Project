                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('vehicleTypes.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="vehicle_type" value="{{ $vehicleType->vehicle_type }}" placeholder="{{ $vehicleType->vehicle_Type }}"  id="vehicleType" class="form-control @error('vehicle_type') is-invalid @enderror" readonly>
                            @error('vehicle_type')
                            <span class="invalid-feedback" role="alert">
                                {{ $message }}
                            </span>
