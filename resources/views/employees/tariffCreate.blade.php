                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('tariffs.save') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="rate_Per_Day" id="rate_Per_Day" class="form-control @error('rate_Per_Day') is-invalid @enderror" required>
                            @error('rate_Per_Day')
                            <span class="invalid-feedback" role="alert">
                                {{ $message }}
                            </span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="rent_Per_Hour" id="rent_Per_Hour" class="form-control @error('rent_Per_Hour') is-invalid @enderror" required>
                            @error('rent_Per_Hour')
                            <span class="invalid-feedback" role="alert">
                                {{ $message }}
                            </span>
